...
<head>
    ...
    <title>{{ config('app.PROJECT_NAME') }} | Log in</title>
...
<div class="login-box">
    <div class="login-logo">
        <a href="jovascript:void(0);"><img src="{{ URL::asset('assets/web') }}/images/logo.png" ></a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <form role="form" method="POST" action="{{ url('/admin/login') }}">
            ...
            <div class="row">
                ...
                <!-- /.col -->
                <div class="col-xs-4">
                    <button type="submit" name="submit" value="Login" class="btn btn-primary btn-block btn-flat">Login</button>
                </div>
                <!-- /.col -->
            </div>
        </form>
